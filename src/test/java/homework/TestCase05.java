...
public class TestCase05 {
    ...
    public void TestCase05(){
        ...
        try{
            // default info
            String firstName = "Doan Viet";
            String lastName = "Thanh";
            String email = "doanvietthanhhs005@gmail.com";
            String password = "@Thanhdoan123";
            String confirmPass = "@Thanhdoan123";
            ...
            System.out.println("Expected message: " + "WELCOME, DOAN VIET THANH!");
            System.out.println("Actual message: " + msg.getText());
            AssertJUnit.assertEquals(msg.getText(), "WELCOME, DOAN VIET THANH!");
            // stop 1s
            Thread.sleep(1000);
            //6. Go to TV menu
            ...
            // sleep 1s
            Thread.sleep(1000);
            driver.findElement(By.xpath("//textarea[@id='message']")).sendKeys("Hello, i'm Thanh");
            // sleep 1s
            Thread.sleep(1000);
            //10.Check wishlist is shared. Expected wishlist shared successfully.
            driver.findElement(By.xpath("//span[contains(text(),'Share Wishlist')]")).click();
            ...
            String png = ("D:\\FPT\\Kì 5\\SWT\\SWT301-SeleniumWebdriver-Ecommerce-main\\SWT301-SeleniumWebdriver-Ecommerce-main\\src\\test\\java\\homework\\TestCase05.png");
